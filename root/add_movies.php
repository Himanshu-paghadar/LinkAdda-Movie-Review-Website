...
<body>
    <h2 class="text-center text-light my-4">Insert Movies</h2>
    <div class="container d-flex justify-content-center">
        <form method="post" action="root_movies.php" class="w-50" enctype="multipart/form-data">
            <div class="form-group my-3">
                <input type="text" name="name" class="form-control" placeholder="Movies Title">
            </div>
            <div class="form-group my-3">
            ...
            <div class="form-group my-3">
                <input type="submit" name="add_movies" class="btn btn-primary text-light" >
            </div>
        </form>
    </div>
</body>
