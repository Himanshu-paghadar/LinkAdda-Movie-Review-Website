...
if(isset($_post['Upd_kids'])){
    ...
    $upd = "UPDATE kids set id='$id',description='$desc', platform='$platform',genre='$genre',year='$year',rating='$rating',poster='$poster',bposter='$bposter' WHERE id='$id' ";
...
<head>
    ...
    <title>Update-Animation Movies</title>
</head>

<body>
<h2 class="text-center text-light my-4">Update Animation Movies</h2>
    <div class="container d-flex justify-content-center">
        <form method="post" class="w-50 " enctype="multipart/form-data">
            <div class="form-group my-3">
                <input type="text" name="name" class="form-control" placeholder="Animation Movies Title" value="<?php echo $d_name ?>">
            </div>
            <div class="form-group my-3">
            ...
            <div class="form-group my-3">
                <input type="submit" name="Upd_kids" class="btn btn-primary text-light" >
            </div>
        </form>
    </div>
