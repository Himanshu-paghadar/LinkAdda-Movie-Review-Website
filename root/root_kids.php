...
if(isset($_POST['add_kids'])){
    ...
    $sql = "INSERT INTO kids (name,description,platform,genre,year,rating,sposter,bposter) VALUES('$name','$desc','$platform','$genre','$year','$rating','$upload_po','$upload_bpo')";
...
if ($username == null) {
    ...
    <body>
    <div class="container">
        <button class="btn btn-primary my-5"><a href="add_kids.php" class="text-light">Add Animation Movie</a></button>
        <table class="table">
                ...
                if ($res) {
                    while ($row = mysqli_fetch_assoc($res)){
                        ...
                        echo '<tr>
                                ...
                                <td><button class="btn btn-primary"><a class="text-light" href="updatekids.php?UpdateKids='.$id.'">Update</a></button>
                                    <button class="btn btn-danger"><a class="text-light" href="delete.php?DeleteKids='.$id.'">Delete</a></button>
                                </td>
                            </tr>';
                    }
                }
