...
<body>
    <h2 class="text-center text-light my-4">Insert Series</h2>
    <div class="container d-flex justify-content-center">
        <form method="post" action="root_series.php" class="w-50" enctype="multipart/form-data">
            <div class="form-group my-3">
                <input type="text" name="name" class="form-control" placeholder="Series Title">
            </div>
            <div class="form-group my-3">
            ...
            <div class="form-group my-3">
                <input type="submit" name="add_series" class="btn btn-primary text-light" >
            </div>
        </form>
    </div>
</body>
